...
import { AddonReview, Addon, AddonCreationParam, AddonReviewBody } from '../interfaces/addons'
...
export class AddonChangeController extends Controller {
  ...
  public async addonReview(@Path() id_or_slug: string, @Body() data: AddonReviewBody, @Request() request: any): Promise<void> {
